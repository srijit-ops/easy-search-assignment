  ...
  return (
    <div>
      <div className="flex justify-between items-center flex-wrap mb-10">
        <h2 className="text-3xl text-gray-800 font-semibold tracking-wider">
          All todos
        </h2>
        <button
          className="px-4 py-2 text-white bg-[#546ef3] hover:bg-gray-950 flex justify-between items-center gap-2 rounded-lg"
          onClick={onOpenModal}
        >
          <FontAwesomeIcon icon={faPlus} className="text-lg" />
          <p className="sm:block hidden">Add new</p>
        </button>
      </div>
      <CustomModal
        open={open}
      ...
      >
        ...
        <div className="flex justify-center items-center mt-8">
          <button
            className="rounded-lg px-6 py-2 bg-[#546ef3] hover:bg-gray-950 text-white"
